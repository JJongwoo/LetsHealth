#ifndef __SceneTrans__SoloPlayScene__
#define __SceneTrans__SoloPlayScene__

#include "cocos2d.h"
USING_NS_CC;

class SoloPlayScene : public cocos2d::LayerColor
{
public:
...
#endif /* defined(__SceneTrans__SoloPlayScene__) */